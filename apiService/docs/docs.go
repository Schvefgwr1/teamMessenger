...
const docTemplate = `{
        ...
        "/roles/{role_id}/permissions": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Список ID permissions",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Permissions успешно обновлены",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateUserRoleRequestGateway"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.UpdateUserRoleRequestGateway": {
            "type": "object",
            "required": [
                "role_id"
            ],
