...
echo "Starting migration and debug script..."
...
# Запускаем отладчик вместо основного приложения
echo "Starting debugger with delve..."
exec dlv --listen=:4001 --headless=true --api-version=2 --accept-multiclient exec ./main
